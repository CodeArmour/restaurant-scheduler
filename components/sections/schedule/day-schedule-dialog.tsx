      ...
      <DialogContent className="max-w-3xl">
        <DialogHeader>
          <DialogTitle className="text-xl">
            {selectedDay ? `Schedule for ${selectedDay.toLocaleDateString()}` : "Schedule"}
          </DialogTitle>
        </DialogHeader>
        ...
        {selectedDay && (
          <Tabs defaultValue="current" className="mt-2">
            <TabsList className="grid w-full grid-cols-2">
              ...
              <TabsTrigger value="add">Add Workers</TabsTrigger>
            </TabsList>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    <div className="flex items-center gap-2">
                      ...
                      <h3 className="font-medium">
                        Kitchen Staff ({countWorkersByPosition(formatDate(selectedDay), "kitchen")}/4)
                      </h3>
                    </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-2">
                      ...
                      <h3 className="font-medium">
                        Cashiers ({countWorkersByPosition(formatDate(selectedDay), "cashier")}/3)
                      </h3>
                    </div>
                    <div className="space-y-2 rounded-lg border p-1">
                      {getDaySchedule(formatDate(selectedDay))
