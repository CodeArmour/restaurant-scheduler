    ...
    <div className="overflow-x-auto pb-4">
      <div className="min-w-[600px]">
        <div className="grid grid-cols-7 gap-px">
          <div className="text-center font-medium p-2 text-sm">Sun</div>
          <div className="text-center font-medium p-2 text-sm">Mon</div>
          <div className="text-center font-medium p-2 text-sm">Tue</div>
          <div className="text-center font-medium p-2 text-sm">Wed</div>
          <div className="text-center font-medium p-2 text-sm">Thu</div>
          <div className="text-center font-medium p-2 text-sm">Fri</div>
          <div className="text-center font-medium p-2 text-sm">Sat</div>
          {renderCalendar()}
        </div>
      </div>
    </div>
