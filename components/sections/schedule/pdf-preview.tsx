  ...
  useEffect(() => {
    ...
    let html = `
      <div style="font-family: Arial, sans-serif; max-width: 100%; margin: 0 auto; padding: 20px;">
        <div style="text-align: left; margin-bottom: 5px; font-size: 12px; color: #666;">1 of 1</div>
        <h2 style="text-align: center; margin-bottom: 15px; font-size: 18px;">${monthName} ${year} - Restaurant Staff Schedule</h2>
        <table style="width: 100%; border-collapse: collapse; border: 1px solid #000; font-size: 12px;">
          <thead>
            <tr style="background-color: #f2f2f2;">
              ...
              <th style="border: 1px solid #000; padding: 6px; width: 80px; text-align: center; font-weight: bold;">Day</th>
              <th style="border: 1px solid #000; padding: 6px; text-align: center; font-weight: bold;">Cashier 1</th>
              <th style="border: 1px solid #000; padding: 6px; text-align: center; font-weight: bold;">Cashier 2</th>
              <th style="border: 1px solid #000; padding: 6px; text-align: center; font-weight: bold;">Cashier 3</th>
              <th style="border: 1px solid #000; padding: 6px; text-align: center; font-weight: bold;">Kitchen 1</th>
              <th style="border: 1px solid #000; padding: 6px; text-align: center; font-weight: bold;">Kitchen 2</th>
              <th style="border: 1px solid #000; padding: 6px; text-align: center; font-weight: bold;">Kitchen 3</th>
              <th style="border: 1px solid #000; padding: 6px; text-align: center; font-weight: bold;">Kitchen 4</th>
            </tr>
          </thead>
          <tbody>
    `
  ...
  const handlePrint = () => {
    ...
    if (printWindow) {
      printWindow.document.write(`
        <html>
          <head>
            <title>Restaurant Staff Schedule</title>
            <style>
              @page {
                size: A4 portrait;
                margin: 10mm;
    ...
    <Card className="mt-6 border-border/40">
      <CardContent className="p-4 sm:p-6">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-lg font-semibold">Schedule Preview (A4 Format)</h3>
        ...
        <div className="border rounded-md overflow-auto max-h-[600px] bg-white dark:bg-gray-100 dark:text-gray-900">
          <div
            ...
            className="min-w-[800px]" // Ensure minimum width for desktop
          />
        </div>
      </CardContent>
    </Card>
